...
<body>
  ...
  <div class="min-h-screen! text-xs lg:text-sm! bg-[#E8EFEC] py-20 px-40">
    <div id="lead-entries">
                        ...
                        <div class="p-3">
                            ...
                            <div class="w-full grid grid-cols-2 gap-2 mt-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="province" class="select2 province-select bg-[#D9D9D9]! rounded-lg! px-3! py-2! border! border-[#D9D9D9]! text-[#1E1E1E]! focus:outline-none!">
                  ...
                  <div class="w-full grid grid-cols-2 mt-3 gap-3">
                      ...
                      <div class="w-full grid grid-cols-1">
                          ...
                          <div class="w-full mt-3">
                              ...
                              <select name="factory_province" class="form-select select2 factory-province-select">
                              <option value="" selected>Pilih</option>
                              @foreach($provinces as $province)
                                <option value="{{ $province }}">{{ $province }}</option>
                              @endforeach
