            ...
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="{{ request()->routeIs('dashboard') ? '#115640' : '#1E1E1E' }}" />
                </svg>

                <span
                    class="sidebar-label {{ request()->routeIs('dashboard') ? 'text-[#115640]' : 'text-[#1E1E1E]' }} font-semibold sm:hidden lg:inline">Dashboard
                </span>
            </a>
        </li>
        @endif
            ...
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="{{ request()->routeIs('orders*') ? '#115640' : '#1E1E1E' }}" />
                </svg>
                <span
                    class="sidebar-label {{ request()->routeIs('orders*') ? 'text-[#115640]' : 'text-[#1E1E1E]' }} font-semibold sm:hidden lg:inline">Orders</span>
            </a>
        </li>
        @endif
        ...
        <li
            ...
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M6 0C4.895 0 4 0.895 4 2H3C1.895 2 1 2.895 1 4V18C1 19.105 1.895 20 3 20H15C16.105 20 17 19.105 17 18V4C17 2.895 16.105 2 15 2H14C14 0.895 13.105 0 12 0H6ZM6 2H12V4H6V2ZM5 8H13V10H5V8ZM5 12H13V14H5V12ZM5 16H10V18H5V16Z"
            ...
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="{{ request()->routeIs('incentives.dashboard') ? '#115640' : '#1E1E1E' }}" />
                </svg>
                <span
                    class="sidebar-label {{ request()->routeIs('incentives.dashboard') ? 'text-[#115640]' : 'text-[#1E1E1E]' }} font-semibold sm:hidden lg:inline">Incentives</span>
            </a>
        </li>
        @endif
