<ul class="flex flex-col bg-white pt-10 sticky top-0 h-screen">
    ...
    <div class="flex-1 overflow-y-auto px-2">
        ...
        <li
            class="{{ request()->routeIs('dashboard') ? 'bg-[#E8EFEC]' : 'bg-white' }} lg:flex lg:items-center lg:justify-start rounded-lg mt-10 px-3 py-2 sm:grid sm:grid-cols-1 sm:place-items-center">
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <span
                    class="{{ request()->routeIs('dashboard') ? 'text-[#115640]' : 'text-[#0D0F11]' }} font-semibold sm:hidden lg:inline">Dashboard</span>
            </a>
        </li>
        @endif
        ...
        <li id="listLeads"
            ...
            <button
                class="cursor-pointer w-full text-left rounded-lg px-3 py-2 mt-2 grid place-items-center lg:flex lg:items-center lg:justify-between"
                ...
                <i id="chevronLeadsMenu"
                    class="sm:hidden! lg:inline-block! fas fa-chevron-right transition-transform duration-300 text-black"
        ...
        <li
            class="{{ request()->routeIs('orders*') ? 'bg-[#E8EFEC]' : 'bg-white' }} lg:flex lg:items-center lg:justify-start rounded-lg mt-2 px-3 py-2 sm:grid sm:grid-cols-1 sm:place-items-center">
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <span
                    class="{{ request()->routeIs('orders*') ? 'text-[#115640]' : 'text-[#0D0F11]' }} font-semibold sm:hidden lg:inline">Orders</span>
            </a>
        </li>
        @endif
        ...
        <li
            class="{{ request()->routeIs('finance-requests.*') ? 'bg-[#E8EFEC]' : 'bg-white' }} lg:flex lg:items-center lg:justify-start rounded-lg mt-2 px-3 py-2 sm:grid sm:grid-cols-1 sm:place-items-center">
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                href="{{ route('finance-requests.index') }}">
                <i class="fas fa-fw fa-file-invoice-dollar"></i>
                <span
                    class="{{ request()->routeIs('finance-requests.*') ? 'text-[#115640]' : 'text-[#0D0F11]' }} font-semibold sm:hidden lg:inline">Finance
                    Requests</span>
            </a>
        </li>
        @endif
        ...
        <li
            class="{{ request()->routeIs('incentives.dashboard') ? 'bg-[#E8EFEC]' : 'bg-white' }} lg:flex lg:items-center lg:justify-start rounded-lg mt-2 px-3 py-2 sm:grid sm:grid-cols-1 sm:place-items-center">
            <a class="lg:flex lg:items-center lg:gap-3 grid grid-cols-1 place-items-center lg:justify-start"
                ...
                <span
                    class="{{ request()->routeIs('incentives.dashboard') ? 'text-[#115640]' : 'text-[#0D0F11]' }} font-semibold sm:hidden lg:inline">Incentives</span>
            </a>
        </li>
        @endif
            ...
            <div id="mastersMenu"
                ...
                <div class="lg:pl-4 lg:space-y-2 pl-2 space-y-1">
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/companies*')}}"
                        href="{{ route('masters.companies.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/companies*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                        </span>
                        <span
                            class="{{ request()->is('masters/companies*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                            Companies
                        </span>
                    </a>
                    @endif
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/provinces*') }}"
                        href="{{ route('masters.provinces.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/provinces*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">

                        </span>
                        <span
                            class="{{ request()->is('masters/provinces*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                            Provinces
                        </span>
                    </a>
                    @endif
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/branches*')}}"
                        ...
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/branches*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/expense-types*') }}"
                        href="{{ route('masters.expense-types.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/expense-types*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/customer-types*')}}"
                        href="{{ route('masters.customer-types.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/customer-types*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                        </span>
                        <span
                            class="{{ request()->is('masters/customer-types*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                            Customer Types
                        </span>
                    </a>
                    @endif
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/product-categories*')}}"
                        ...
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/product-categories*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">

                        </span>
                        <span
                            class="{{ request()->is('masters/product-categories*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                            Product Categories
                        </span>
                    </a>
                    @endif
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/parts*') }}"
                        href="{{ route('masters.parts.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/parts*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/products*') }}"
                        href="{{ route('masters.products.index') }}">
                        <span
                            class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/products*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">

                        </span>
                        <span
                            class="{{ request()->is('masters/products*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                            Products
                        </span>
                    </a>
                    @endif
            ...
            <div id="settingsMenu"
                ...
                <div class="lg:pl-4 lg:space-y-2 pl-2 space-y-1">
                    ...
                    <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('settings/permissions*') }}"
                        ...
                        <span
                            class="{{ request()->is('settings/permissions*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
    ...
    <div class="mt-auto py-4 border-t border-[#CFD5DC]">
        ...
        <div id="toggleUserInfo"
            ...
            <i id="chevronUserInfo"
                class="sm:hidden! lg:inline-block! fas fa-chevron-up transition-transform duration-300 text-black"
                style="font-size: 16px;"></i>
        </div>
