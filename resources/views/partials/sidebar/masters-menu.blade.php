<li id="listMasters" class="{{ request()->is('masters/*')}} rounded-lg mt-2">
    <button id="mastersToggle"
        ...
        <div class="lg:flex! lg:items-center! lg:justify-start! lg:gap-3!">
            ...
            <span id="mastersSpan" class="sidebar-label text-[#010508] font-semibold sm:hidden lg:inline">Masters</span>
        </div>
    ...
    <div id="mastersMenu"
        ...
        <div class="lg:pl-4 lg:space-y-2 pl-2 space-y-1">
            ...
            {{-- MASTER SOURCES --}}
            @if(auth()->check() && auth()->user()->hasPermission('masters.sources'))
            <a class="flex items-center sm:gap-2 lg:gap-3 {{ request()->routeIs('masters/sources*')}}"
                href="{{ route('masters.sources.index') }}">
                <span
                    class="block sm:h-[15px] lg:h-[20px] w-[3px] {{ request()->is('masters/sources*') ? 'bg-[#115640]' : 'bg-[#6B7786]' }}">
                </span>
                <span
                    class="{{ request()->is('masters/sources*') ? 'text-[#115640]' : 'text-[#6B7786]' }} font-semibold sm:text-xs lg:text-sm">
                    Source
                </span>
            </a>
            @endif
...
<script>
    ...
    function openMasters() {
        ...
        mastersToggle.classList.add('bg-[#CFE7DE]');
    ...
    function closeMasters() {
        ...
        mastersToggle.classList.remove('bg-[#CFE7DE]');
