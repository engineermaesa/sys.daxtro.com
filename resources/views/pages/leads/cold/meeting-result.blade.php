    ...
    <form id="form"
      ...
      <div class="bg-white border border-[#D9D9D9] rounded mt-4">
        ...
        <div class="p-2! lg:px-3! lg:py-2! text-[#1E1E1E]">
          ...
          <select name="result" id="result" class="w-full p-2! lg:px-3! lg:py-2! rounded-lg border border-[#D9D9D9]" required>
        ...
        <div class="p-2! lg:px-3! lg:py-2! text-[#1E1E1E]">
          ...
          <textarea name="summary" id="summary" class="w-full p-2! lg:px-3! lg:py-2! rounded-lg border border-[#D9D9D9]" rows="4" placeholder="Type Here To Input Summary..." required>{{ old('summary', $data->summary) }}</textarea>
        </div>
      ...
      <div class="flex justify-end gap-3 sm:mt-3 lg:mt-5">
        <a href="{{ route('leads.my') }}" class="cursor-pointer p-2 lg:px-3 lg:py-2 bg-white border border-[#115640] rounded-lg text-[#1E1E1E] font-semibold">Back</a>
        <button type="submit" class="cursor-pointer p-2 lg:px-3 lg:py-2 bg-[#115640] border border-[#115640] rounded-lg text-white font-semibold">Submit Result</button>
      </div>
    </form>
  </div>
</section>
