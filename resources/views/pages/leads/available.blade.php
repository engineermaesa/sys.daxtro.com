...
@section('content')
<div class="min-h-screen sm:text-xs! lg:text-sm!">
  {{-- HEADER PAGES --}}
  <div class="pt-4">
  ...
  <section class="bg-white border border-[#D9D9D9] rounded-lg mt-3 mb-4">
    ...
    <div class="lg:flex lg:px-3 lg:py-4 gap-3 grid grid-cols-1 px-2 py-3 border-b border-b-[#D9D9D9]">
        ...
        <div class="sm:grid sm:grid-cols-2 sm:grid-cols-[3fr_1fr] gap-4 lg:hidden">
          <div class="lg:w-1/4! border border-gray-300 rounded-lg flex items-center p-2">
              <div class="px-2">
              ...
              <input type="text" placeholder="Search..." class="w-full px-3 py-1 border-none focus:outline-[#115640] globalSearch"/>
          </div>
          
          <button id="btnExport" class="lg:w-1/4! bg-[#115640] text-white font-semibold rounded-lg cursor-pointer" type="button">
            <i class="bi bi-download me-1"></i> Export Excel
          </button>
        </div>

        {{-- FILTERS SEARCH --}}
        <div class="lg:w-1/4! border border-gray-300 rounded-lg lg:flex! items-center p-2 hidden">
            <div class="px-2">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.5 13C4.68333 13 3.14583 12.3708 1.8875 11.1125C0.629167 9.85417 0 8.31667 0 6.5C0 4.68333 0.629167 3.14583 1.8875 1.8875C3.14583 0.629167 4.68333 0 6.5 0C8.31667 0 9.85417 0.629167 11.1125 1.8875C12.3708 3.14583 13 4.68333 13 6.5C13 7.23333 12.8833 7.925 12.65 8.575C12.4167 9.225 12.1 9.8 11.7 10.3L17.3 15.9C17.4833 16.0833 17.575 16.3167 17.575 16.6C17.575 16.8833 17.4833 17.1167 17.3 17.3C17.1167 17.4833 16.8833 17.575 16.6 17.575C16.3167 17.575 16.0833 17.4833 15.9 17.3L10.3 11.7C9.8 12.1 9.225 12.4167 8.575 12.65C7.925 12.8833 7.23333 13 6.5 13ZM6.5 11C7.75 11 8.8125 10.5625 9.6875 9.6875C10.5625 8.8125 11 7.75 11 6.5C11 5.25 10.5625 4.1875 9.6875 3.3125C8.8125 2.4375 7.75 2 6.5 2C5.25 2 4.1875 2.4375 3.3125 3.3125C2.4375 4.1875 2 5.25 2 6.5C2 7.75 2.4375 8.8125 3.3125 9.6875C4.1875 10.5625 5.25 11 6.5 11Z" fill="#6B7786"/>
                </svg>
        ...
        {{-- FILTERS MENUS --}}
        <div class="lg:w-1/2! grid grid-cols-3 items-center border border-gray-300 rounded-lg text-[#1E1E1E] max-lg:text-xs!">
        ...
        <div class="lg:w-1/4! flex items-center gap-3">
          @if(auth()->user()->role?->code === 'branch_manager')
            <a href="{{ route('contact-us') }}" class="flex justify-center items-center gap-2 p-2 w-full h-full rounded-lg bg-white border border-[#115640]">
              ...
              <p class="text-[#1E1E1E] font-medium">Leads Manually</p>
            </a>
          @endif
      ...
      <table id="availableLeadsTable" class="w-full text-[#1E1E1E]">
        <thead class="border-b border-b-[#D9D9D9]">
          <tr>
            ...
            <th class="font-bold text-left lg:p-3 sm:p-1">Industry To Be</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Industry Existing</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Industry</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Product</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Tonage</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Regional</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Source</th>
            <th class="font-bold text-left lg:p-3 sm:p-1">Segment</th>
            <th class="font-bold text-center lg:p-3 sm:p-1">Actions</th>
          </tr>
        </thead>
