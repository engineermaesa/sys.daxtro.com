...
<section class="min-h-screen sm:text-xs lg:text-sm">
    <div class="pt-4">
        ...
        <form method="POST"
            action="{{ request()->routeIs('leads.my.form') ? route('leads.my.save', $form_data->id) : route('leads.save', $form_data->id) }}"
            id="form"
                    ...
                    <div class="bg-white rounded-lg">
                        ...
                        <div class="p-3 grid grid-cols-5 gap-3 justify-between">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 gap-1">
                                    ...
                                    <select name="{{ $isCreate ? 'title[]' : 'title' }}"
                            ...
                            <div class="grid grid-cols-1 gap-1">
                                ...
                                <input type="text" name="{{ $isCreate ? 'name[]' : 'name' }}" placeholder="Nama Lengkap"
                                    class="px-3! py-2! border! border-[#D9D9D9]! rounded-lg! text-[#1E1E1E]! focus:outline-none!"
                            ...
                            <div class="grid grid-cols-1 gap-1">
                                ...
                                <select name="{{ $isCreate ? 'jabatan_id[]' : 'jabatan_id' }}"
                                    class="px-3! py-2! border! border-[#D9D9D9]! rounded-lg! text-[#1E1E1E]! focus:outline-none!"
                                    required>
                                    <option value="" disabled selected>Pilih</option>
                                    @foreach($jabatans as $jabatan)
                                    <option value="{{ $jabatan->id }}" {{ old('jabatan_id', $form_data->jabatan_id) ==
                                        $jabatan->id ? 'selected' : '' }}>{{ $jabatan->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-1">
                                ...
                                <input type="text" name="{{ $isCreate ? 'phone[]' : 'phone' }}"
                            ...
                            <div class="grid grid-cols-1 gap-1">
                                ...
                                <input type="email" name="{{ $isCreate ? 'email[]' : 'email' }}"
                        ...
                        <div class="pic-extensions">
                            ...
                            <div class="pic-entry p-3 grid grid-cols-6 gap-2">
                                ...
                                <div class="grid grid-cols-1 gap-1">
                                    <label class="text-[#1E1E1E]! mb-1!">Name <i class="required">*</i></label>
                                    <input type="text" name="{{ $isCreate ? 'name[]' : 'name' }}"
                        ...
                        <div class="bg-white rounded-lg">
                            ...
                            <div class="p-3">
                                ...
                                <div class="w-full grid grid-cols-1">
                                    <label class="text-[#1E1E1E]! mb-2! block!">Company Name<i
                                            class="required">*</i></label>
                                    <input type="text" name="{{ $isCreate ? 'company[]' : 'company' }}"
                                ...
                                <div class="w-full grid grid-cols-2 gap-2 mt-3">
                                    ...
                                    <div class="w-full">
                                        <label class="text-[#1E1E1E]! mb-2! block!">Customer City <i
                                                class="required">*</i></label>
                                        <select name="{{ $isCreate ? 'region_id[]' : 'region_id' }}"
                                            class="select2 region-select rounded-lg! px-3! py-2! border! border-[#D9D9D9]! text-[#1E1E1E]! focus:outline-none!"
                                            required>
                                            <option value="" disabled {{ old('region_id', $form_data->region_id)===null
                                                ? 'selected' : '' }}>Pilih</option>
                                            <option value="ALL" {{ old('region_id', $form_data->region_id)==='ALL' ?
                                                'selected' : '' }}>
                                        ...
                                        <input type="hidden" name="{{ $isCreate ? 'branch_id[]' : 'branch_id' }}"
                                    ...
                                    <div class="w-full">
                                        <label class="text-[#1E1E1E]! mb-2! block!">Customer Province <i
                                                class="required">*</i></label>
                                        <select name="{{ $isCreate ? 'province[]' : 'province' }}"
                                            ...
                                            <option value="{{ $prov }}" {{ old('province', $form_data->province) ==
                                                $prov ? 'selected' : '' }}>
                                                {{ $prov }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="w-full grid grid-cols-1 mt-3">
                                    <label class="text-[#1E1E1E]! mb-2! block!">Company Address<i
                                            class="required">*</i></label>
                                    <textarea name="{{ $isCreate ? 'company_address[]' : 'company_address' }}"
                        ...
                        <div class="bg-white rounded-lg">
                            ...
                            <div class="p-3">
                                ...
                                <div class="w-full grid grid-cols-1">
                                    ...
                                    <select name="{{ $isCreate ? 'source_id[]' : 'source_id' }}"
                                ...
                                <div class="w-full grid grid-cols-1 mt-3">
                                    {{-- CUSTOMER CITY FIELD SELECT --}}
                                    <div class="w-full">
                                        <label class="text-[#1E1E1E]! mb-2! block!">Customer Type <i
                                                class="required">*</i></label>
                                        <select name="{{ $isCreate ? 'customer_type[]' : 'customer_type' }}"
                                            class="form-select select2" required>
                                            <option value="" disabled selected>Pilih</option>
                                            @foreach($customerTypes as $type)
                                            <option value="{{ $type->name }}" {{ old('customer_type', $form_data->
                                                customer_type) == $type->name ? 'selected' : '' }}>{{ $type->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="w-full grid grid-cols-1 mt-3">
                                    <label class="text-[#1E1E1E]! mb-2! block!">Existing Customer Industry<i
                                            class="required">*</i></label>
                                    <select name="{{ $isCreate ? 'industry_id[]' : 'industry_id' }}"
                                        class="form-select select2 industry-select" required>
                                        <option value="" disabled selected>Pilih</option>
                                        @foreach($industries as $industry)
                                        <option value="{{ $industry->id }}" {{ old('industry_id', $form_data->
                                            industry_id ?? ($form_data->other_industry ? 'other' : null)) ==
                                            $industry->id ? 'selected' : '' }}>{{ $industry->name }}</option>
                                        @endforeach
                                        <option value="other" {{ old('industry_id', $form_data->industry_id ??
                                            ($form_data->other_industry ? 'other' : null)) === 'other' ? 'selected' : ''
                                            }}>Lainnya</option>
                                    </select>
                                    <input type="text" name="{{ $isCreate ? 'other_industry[]' : 'other_industry' }}"
                                        class="form-control mt-2 industry-other d-none" placeholder="Isi industri"
                                        value="{{ old('other_industry', $form_data->other_industry) }}" />
                                </div>

                                {{-- ASSIGNMENT FOR SALES DIRECTOR / SUPER ADMIN --}}
                            ...
                            <div class="p-3">
                                ...
                                <div class="grid grid-cols-2 gap-3 mt-3">
                                    <div class="grid grid-cols-1">
                                        <label class="text-[#1E1E1E]! mb-2! block!">Needs (Ice Machine Type)<i
                                                class="required">*</i></label>
                                        <select name="{{ $isCreate ? 'needs[]' : 'needs' }}"
                                            ...
                                            <option value="{{ $need }}" {{ $selectedNeed==$need ? 'selected' : '' }}>{{
                                                $need }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1">
                                        ...
                                        <input type="number" step="0.01" name="{{ $isCreate ? 'tonase[]' : 'tonase' }}"
                                ...
                                <div class="w-full grid grid-cols-2 mt-3 gap-3">
                                    ...
                                    <div class="w-full grid grid-cols-1">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select name="{{ $isCreate ? 'factory_city_id[]' : 'factory_city_id' }}"
                                                class="select2 factory-region-select rounded-lg! px-3! py-2! border! border-[#D9D9D9]! text-[#1E1E1E]! focus:outline-none!">
                                                <option value="" disabled selected>Pilih</option>
                                                <option value="ALL" {{ old('factory_city_id', $form_data->
                                                    factory_city_id) === 'ALL' ? 'selected' : '' }}>
                                                    All Cities
                                                </option>
                                                @foreach($regions as $region)
                                                <option value="{{ $region->id }}" data-branch="{{ $region->branch_id }}"
                                                    data-province="{{ $region->province->name ?? '' }}" {{
                                                    old('factory_city_id', $form_data->factory_city_id) == $region->id ?
                                                    'selected' : '' }}>
                                                    {{ $region->name }}
                                                </option>
                                                @endforeach
                                        ...
                                        <div class="w-full mt-3">
                                            ...
                                            <select name="{{ $isCreate ? 'factory_province[]' : 'factory_province' }}"
                                                class="form-select select2 factory-province-select">
                                                <option value="" selected>Pilih</option>
                                                @foreach ($provinces as $prov)
                                                <option value="{{ $prov }}" {{ old('factory_province', $form_data->
                                                    factory_province) == $prov ? 'selected' : '' }}>
                                                    {{ $prov }}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="w-full mt-3">
                                            ...
                                            <select
                                                name="{{ $isCreate ? 'factory_industry_id[]' : 'factory_industry_id' }}"
                                                class="form-select select2 factory-industry-select">
                                                <option value="" disabled selected>Pilih</option>
                                                @foreach($industries as $industry)
                                                <option value="{{ $industry->id }}" {{ old('factory_industry_id',
                                                    $form_data->factory_industry_id) == $industry->id ? 'selected' : ''
                                                    }}>
                                                    {{ $industry->name }}
                                                </option>
                                                @endforeach
                                                <option value="other" {{ old('factory_industry_id', $form_data->
                                                    factory_industry_id ?? ($form_data->factory_other_industry ? 'other'
                                                    : null)) === 'other' ? 'selected' : '' }}>Lainnya</option>
                                            </select>
                                            <input type="text"
                                                name="{{ $isCreate ? 'factory_other_industry[]' : 'factory_other_industry' }}"
            ...
            <div class="bg-white rounded-lg">
                ...
                <table class="w-full">
                    ...
                    <tr class="border-b border-b-[#D9D9D9]">
                        ...
                        <td class="text-[#1E1E1E]">{{ trim(($meeting->city ?? '') . ' ' . ($meeting->address ?? '')) }}
                        </td>
                    </tr>
                    @endif
                    <tr class="border-b border-b-[#D9D9D9]">
