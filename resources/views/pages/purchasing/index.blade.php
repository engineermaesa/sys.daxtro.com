            ...
            <div class="flex justify-between items-center">
                ...
                <div id="forAllCardsCounts" class="grid max-xl:grid-cols-2 grid-cols-3 gap-3 mt-4">
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countInvoiceReceived" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                Invoice Received</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countVendorProcessing" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                Vendor Processing</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countReadyForHandover" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countAllCompleted" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                Completed</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countAllPending" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 Pendings
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countAllCanceled" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 Canceled
                            </p>
                        </div>
                    </div>
                ...
                <div id="forInvoiceReceivedCardsCounts" class="grid grid-cols-3 gap-3 mt-4">
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countWaitingList" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 Waiting
                                List</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countAcceptedList" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                Accepted</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countOnProgressList" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 On
                                Progress Production</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="forVendorProcessingCardsCounts" class="grid grid-cols-2 2xl:grid-cols-4 gap-3 mt-4">
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div class="mb-5">
                            <p id="countOnProduction" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 On
                                Production</p>
                        </div>
                    ...
                    <div>
                        <p id="countVendorProcessing" class="text-2xl font-semibold text-[#1E1E1E]">0 Vendor Processing
                        </p>
                        {{-- RUNNING TEST --}}
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countRunningTestList" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Running Tested</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countMachineCompletedList"
                                    class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 Machine Completed</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countDocumentRegisterList"
                                    class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0 Document Registered</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div class="mb-5">
                                <p id="countTotalDelivery" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Total Delivery</p>
                            </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countDeliveryCustomer" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Delivery Customer</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countProgressInstall" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Progress Install</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                            ...
                            <div>
                                <p id="countRunningTestFinal" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Running Test Final</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countReadyForHandover" class="text-2xl font-semibold text-[#1E1E1E]">0 Ready For
                                Handover
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <p id="countCompletedOnly" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Completed</p>
                            </div>
                        </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <p id="countPendingOnly" class="2xl:text-xl text-lg font-semibold text-[#1E1E1E]">0
                                    Pending</p>
                            </div>
                        </div>
                ...
                <div id="forInvoiceReceivedCardsCounts" class="grid grid-cols-1 xl:grid-cols-3 gap-3 mt-4">
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countOnProgressList" class="text-2xl font-semibold text-[#1E1E1E]">0 In Progress
                                Production</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="forVendorProcessingCardsCounts" class="grid grid-cols-1 xl:grid-cols-4 gap-3 mt-4">
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countRunningTestList" class="text-2xl font-semibold text-[#1E1E1E]">0 Running Tested
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countMachineCompletedList" class="text-2xl font-semibold text-[#1E1E1E]">0 Machine
                                Completed</p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countDocumentRegisterList" class="text-2xl font-semibold text-[#1E1E1E]">0 Document
                                Registered
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div class="mb-5">
                            <p id="countTotalDelivery" class="text-2xl font-semibold text-[#1E1E1E]">0 Total Delivery
                            </p>
                        </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countDeliveryCustomer" class="text-2xl font-semibold text-[#1E1E1E]">0 Delivery
                                Customer
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countProgressInstead" class="text-2xl font-semibold text-[#1E1E1E]">0 Progress
                                Instead
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-white border border-[#D9D9D9] rounded-lg animate__animated animate__fadeInUp"
                        ...
                        <div>
                            <p id="countRunningTestFinal" class="text-2xl font-semibold text-[#1E1E1E]">0 Running Test
                                Final
                            </p>
                        </div>
                    </div>
                ...
                <div class="mt-4 rounded-lg border-[#D9D9D9]">
                    ...
                    <div
                        ...
                        <div class="lg:w-5/6! border border-[#D5D5D5] rounded-lg grid grid-cols-7">
                            @foreach(['all', 'invoiceReceived', 'vendorProcessing', 'readyForHandover', 'completed',
                            'pending',
                            'canceled'] as $tab)
                            {{-- NAVIGATION STATUS --}}
                            <div data-status="{{ $tab }}"
                                ...
                                <p class="text-[#1E1E1E]">
                                    {{ $loop->first ? 'All Stage' : ucwords(preg_replace('/([a-z])([A-Z])/', '$1 $2',
                                    $tab))
                                    }}
                    ...
                    <div data-status-wrapper="{{ $tab }}"
                        class="purchasing-table-container {{ $loop->first ? '' : 'hidden' }}">
                        ...
                        <div class="flex justify-between items-center px-3 py-2 text-[#1E1E1E]! bg-transparent">
                            <div class="flex items-center gap-3">
                                ...
                                <select id="{{ $tab }}PageSizeSelect"
                                    class="w-auto bg-white font-semibold p-2 rounded-md"
