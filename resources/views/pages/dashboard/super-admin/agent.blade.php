...
<script>
    ...
    function getAgentTrendsExportFilename() {
        const branchName = sanitizeAgentExportFilenamePart(
            getAgentSelectedOptionLabel('branchesQuery', 'All Branches')
        );
    ...
    async function loadAgentDetail(action = 'init', value = null) {
        const API_URL = '/api/dashboard/agent-summary';
        ...
        const branchId = document.getElementById('agentDetailBranch')?.value || '';
        ...
        if (branchId) params.append('agent_branch_id', branchId);
    ...
    function resetAgentDetailFilters() {
        ...
        const branchSelect = document.getElementById('agentDetailBranch');
        const provinceSelect = document.getElementById('agentDetailProvince');
        const citySelect = document.getElementById('agentDetailCity');
    ...
    function initAgentDetailFilters() {
        ...
        bindAgentDetailSelectChange('#agentDetailBranch', function () {
            loadAgentDetail('filter');
        });
    ...
    async function loadAgentSummary() {
        try {
            ...
            const apiUrl = params.toString()
                ? `/api/dashboard/agent-summary?${params.toString()}`
                : '/api/dashboard/agent-summary';
