...
@section('content')
        ...
        <div class="card shadow border-left-info">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#summaryBody" aria-expanded="true">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            <em>scope</em> (Global/Jakarta/Makassar/Surabaya) & <em>tahun</em>. Tooltips menampilkan nilai
                            rupiah.
                        </li>
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#donutBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Target vs Sales (Bulanan)</h6>
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#tvsmBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
            <div id="tvsmBody" class="collapse show">
                <div class="card-body">
                    <div class="row g-3 mb-3 ">
                        <div class="col-md-8">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-auto me-3">
                                    <div style="min-width: 160px;">
                                        <input type="date" id="tvsm_start_date" class="form-control form-control-sm"
                                ...
                                <div class="col-auto">
                                    <div style="min-width: 160px;">
                                        <input type="date" id="tvsm_end_date" class="form-control form-control-sm"
                            ...
                            <div class="row g-0 justify-content-end">
                                <div class="col-auto me-2">
                                    <div style="min-width: 110px;">
                                        <button type="button" class="btn btn-sm btn-primary w-100" id="tvsm_apply">
                    ...
                    <!-- Info Alert -->
                    <div class="alert alert-info py-2 mb-3" id="tvsm_range_info">
                        <small><i class="bi bi-info-circle me-1"></i> Menampilkan data untuk periode: <span
                                id="tvsm_range_text"></span></small>
                    </div>
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#coldLeadsBranchBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
            <div id="coldLeadsBranchBody" class="collapse show">
                <div class="card-body">
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <input type="date" id="cl_start" class="form-control form-control-sm"
                                value="{{ $defaultYtdStart }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-3">
                            <input type="date" id="cl_end" class="form-control form-control-sm"
                                value="{{ $defaultYtdEnd }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-2 d-grid">
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#warmLeadsBranchBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
            <div id="warmLeadsBranchBody" class="collapse show">
                <div class="card-body">
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <input type="date" id="wl_start" class="form-control form-control-sm"
                                value="{{ $defaultYtdStart }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-3">
                            <input type="date" id="wl_end" class="form-control form-control-sm"
                                value="{{ $defaultYtdEnd }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-2 d-grid">
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#hotLeadsBranchBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
            <div id="hotLeadsBranchBody" class="collapse show">
                <div class="card-body">
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <input type="date" id="hl_start" class="form-control form-control-sm"
                                value="{{ $defaultYtdStart }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-3">
                            <input type="date" id="hl_end" class="form-control form-control-sm"
                                value="{{ $defaultYtdEnd }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-2 d-grid">
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#salesPerfBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
            <div id="salesPerfBody" class="collapse show">
                <div class="card-body">
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <input type="date" id="sp_start" class="form-control form-control-sm"
                                value="{{ $defaultYtdStart }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-3">
                            <input type="date" id="sp_end" class="form-control form-control-sm"
                                value="{{ $defaultYtdEnd }}" onfocus="this.showPicker()">
                        </div>
                        <div class="col-md-3 d-grid">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-9">
                            ...
                            <small class="text-muted">Pilih maks. 3 sales untuk tren Achievement% (kosongkan = Top 3
                                otomatis)</small>
                        </div>
                        <div class="col-md-3 d-grid">
    ...
    <div class="col-md-12 mb-4">
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-link collapse-toggle" type="button" data-bs-toggle="collapse"
                    data-bs-target="#ordersMonthlyBody" aria-expanded="true">
                    <i class="fas fa-angle-down"></i>
                </button>
            </div>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-md-3 d-grid">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" id="cold_apply">
                                            <i class="bi bi-search me-1"></i> Apply Filters
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-md-3 d-grid">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" id="warm_apply">
                                            <i class="bi bi-search me-1"></i> Apply Filters
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-md-3 d-grid">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" id="hot_apply">
                                            <i class="bi bi-search me-1"></i> Apply Filters
                                        </button>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
                        ...
                        tooltips: {
                            ...
                            callbacks: {
                                label: (t, data) => {
                                    ...
                                    const v = typeof t.yLabel === 'string' ? parseFloat(t.yLabel) : t
                                        .yLabel;
        ...
        function loadTargetVsSalesMonthly() {
            const params = {
                ...
                year: $('#tvsm_year').val(),
                startDate: $('#tvsm_start_date').val(),
                endDate: $('#tvsm_end_date').val()
            };

            // Show loading state
            const applyBtn = $('#tvsm_apply');
            const originalHtml = applyBtn.html();
            applyBtn.html('<i class="bi bi-hourglass-split me-1"></i> Loading...');
            ...
            $.post('{{ route('dashboard.target-vs-sales-monthly') }}', params, function(res) {
                ...
                // Update range info
                updateTVSMRangeInfo(res);

            }).fail(function(xhr, status, error) {
                console.error('Error loading target vs sales data:', error);
                showTVSMError('Gagal memuat data: ' + (xhr.responseJSON?.message || error));
            }).always(function() {
                // Pastikan selalu restore button state
                applyBtn.html('<i class="bi bi-graph-up me-1"></i> Apply');
                applyBtn.prop('disabled', false);
            });
        }

        function updateTVSMRangeInfo(data) {
            const rangeInfo = $('#tvsm_range_info');
            const rangeText = $('#tvsm_range_text');

            if (data.startDate && data.endDate) {
                const start = formatDateToLong(data.startDate);
                const end = formatDateToLong(data.endDate);
                rangeText.text(`${start} - ${end}`);
                rangeInfo.removeClass('d-none');
            } else {
                rangeInfo.addClass('d-none');
            }
        }
        ...
        function showTVSMError(message) {
  ...
  `);
            ...
            $('#tvsmBody .card-body').prepend(alertDiv);
        ...
        function resetTVSMFilters() {
            $('#tvsm_scope').val('global');
            $('#tvsm_year').val(new Date().getFullYear());
            ...
            $('#tvsm_start_date').val(formatDate(firstDay));
            $('#tvsm_end_date').val(formatDate(lastDay));
        ...
        $(document).ready(function() {
            ...
            $('#tvsm_reset').on('click', resetTVSMFilters);

            // Enter key support
            $('#tvsm_year').on('keypress', function(e) {
                if (e.key === 'Enter') loadTargetVsSalesMonthly();
            });
        ...
        function loadSalesAchievementDonuts() {
            ...
            $.post('{{ route('dashboard.sales-achievement-donut') }}', params, function(res) {
                ...
                container.empty();
                // Hapus chart lama
                Object.values(donutBranchCharts).forEach(ch => {
                    try {
                        ch.destroy();
                    } catch (e) {}
                });
      ...
      `);
                        ...
                        tooltips: {
                            ...
                            callbacks: {
                                label: function(t, data) {
                                    const ds = data.datasets[t.datasetIndex];
                                    const val = typeof t.yLabel === 'string' ? parseFloat(t.yLabel) : t
                                        .yLabel;
                    ...
                    options: {
                        ...
                        scales: {
                            ...
                            yAxes: [{
                                ticks: {
                                    beginAtZero: true,
                                    callback: v => 'Rp' + number_format(v, 0, ',', '.')
                                }
                            }]
                        }
                    }
        ...
        $(function() {
            ...
            $('#cl_apply').on('click', function() {
                loadLeadsBranchTrend('cl', 'cold');
            });
            $('#wl_apply').on('click', function() {
                loadLeadsBranchTrend('wl', 'warm');
            });
            $('#hl_apply').on('click', function() {
            ...
            function renderChart(ctx, data, label = 'Jumlah Leads', type = 'bar') {
                ...
                const config = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: label,
                            backgroundColor: type === 'pie' ? backgroundColors.slice(0, values.length) :
                                '#4e73df',
                            data: values
                        }]
                    },
                    ...
                    config.options.tooltips = {
                        callbacks: {
                            label: function(tooltipItem, data) {
                                ...
                                const total = dataset.data.reduce(function(prev, next) {
                                    return prev + next;
                                }, 0);
